/*
 * copied from https://github.com/bumptech/glide/tree/master/integration/recyclerview/src/main/java/com/bumptech/glide/integration/recyclerview
 */
 ...
 *
 * @param <T>
 *     The type of the model being displayed in the {@link RecyclerView}.
 */
...
public final class RecyclerViewPreloader<T> extends RecyclerView.OnScrollListener {
    ...
    public RecyclerViewPreloader(FragmentActivity fragmentActivity,
                                 ...
                                 int maxPreload) {
        this(Glide.with(fragmentActivity),
     ...
     * list of models to preload for a given position, and the request to use to load images.
     *
     * @param preloadModelProvider
     *     Provides models to load and requests capable of loading them.
     * @param preloadDimensionProvider
